...
namespace WebBanking.Rest.Migrations
{
    ...
    [Migration("20210122021337_emailpropAdded")]
            ...
            modelBuilder.Entity("WebBanking.Rest.Models.AcctHolder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Balance = 50000.0,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 968, DateTimeKind.Utc).AddTicks(9469),
                            FullName = "chima",
            ...
            modelBuilder.Entity("WebBanking.Rest.Models.AirtimeTopUp", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 500,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 971, DateTimeKind.Utc).AddTicks(7962),
            ...
            modelBuilder.Entity("WebBanking.Rest.Models.CableRecharge", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CableNo = 9012345,
                            CableType = 1,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 972, DateTimeKind.Utc).AddTicks(5075),
                            SenderId = 1,
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("WebBanking.Rest.Models.CashWithdrawal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 1000,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 972, DateTimeKind.Utc).AddTicks(902),
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            WithdrawerId = 1
                        });
                });
            ...
            modelBuilder.Entity("WebBanking.Rest.Models.Transactions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 972, DateTimeKind.Utc).AddTicks(8557),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 972, DateTimeKind.Utc).AddTicks(8862),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 972, DateTimeKind.Utc).AddTicks(8918),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 972, DateTimeKind.Utc).AddTicks(8959),
            ...
            modelBuilder.Entity("WebBanking.Rest.Models.Transfer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 2000,
                            CreatedAt = new DateTime(2021, 1, 22, 2, 13, 36, 971, DateTimeKind.Utc).AddTicks(3373),
